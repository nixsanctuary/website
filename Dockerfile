# forked from https://github.com/docker-library/ghost/blob/master/4/debian/Dockerfile
...
RUN set -eux; \
	...
	chown node:node -R "$GHOST_CONTENT"/themes/casper && chown node:node -R "$GHOST_CONTENT"/data; \
